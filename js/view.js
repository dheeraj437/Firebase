$(document).ready(function () {
    ...
    function renderEmployee(document) {
        ...
        <td><button style="background-color: green;"><input type="button"  style=" width:100%; height:100%; background-color: green; color: white; font-weight:300px; value="${document.data().bank}"</button></td>
